...
/**
 * Component hiển thị chi tiết bài viết với layout 9/12 + 3/12 sidebar
 * Tối ưu tỷ lệ để tránh mắt bị lệch khi đọc nội dung chính
 */
export default function NewsDetail93() {
  ...
  const SidebarNewsCard = ({ article }: { article: Article }) => {
    ...
    return (
      <Link
        ...
        className="group block p-2 rounded-lg hover:bg-gray-50 transition-colors duration-200"
      >
        {/* Thumbnail nhỏ */}
        ...
        {/* Thông tin bài viết */}
        <div>
          <h4 className="font-medium text-gray-900 mb-1 line-clamp-2 group-hover:text-blue-600 transition-colors text-xs leading-tight">
            {translation.title}
          </h4>
          ...
          <div className="sticky top-8 space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4">
              ...
              <div className="space-y-2">
                {sidebarArticles && sidebarArticles.length > 0 ? (
                  ...
                  <div className="text-center text-gray-500 py-4">
                    ...
                    <p className="text-xs">Đang cập nhật...</p>
                  </div>
                )}
              </div>
              ...
              <div className="mt-3 pt-3 border-t border-gray-200">
                <Link 
                  to="/news" 
                  className="block text-center text-blue-600 hover:text-blue-800 font-medium text-xs"
                >
                  Xem tất cả →
                </Link>
              </div>
            ...
            {/* Liên hệ nhanh */}
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg shadow-lg p-4">
              <h3 className="text-base font-bold text-gray-900 mb-3 flex items-center gap-1">
                <span className="text-sm">📞</span>
                Liên hệ
              </h3>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 p-2 bg-white rounded text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600">24/7 online</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3 space-y-1">
                <Link
                  to="/contact"
                  className="block w-full text-center px-3 py-1.5 bg-green-600 text-white font-medium rounded hover:bg-green-700 transition-colors text-xs"
                >
                  Liên hệ ngay
                </Link>
                <Link
                  to="/appointment"
                  className="block w-full text-center px-3 py-1.5 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition-colors text-xs"
                >
                  Đặt lịch khám
                </Link>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 p-1 text-xs">
                  <span className="text-green-600">✓</span>
                  <span className="text-gray-700">Khám tổng quát</span>
                </li>
                <li className="flex items-center gap-2 p-1 text-xs">
                  <span className="text-green-600">✓</span>
                  <span className="text-gray-700">Xét nghiệm</span>
                </li>
                <li className="flex items-center gap-2 p-1 text-xs">
                  <span className="text-green-600">✓</span>
                ...
                <li className="flex items-center gap-2 p-1 text-xs">
                  <span className="text-green-600">✓</span>
                  <span className="text-gray-700">Cấp cứu 24/7</span>
                </li>
              </ul>

              <Link 
                to="/services" 
                className="block mt-3 text-center text-green-600 hover:text-green-800 font-medium text-xs"
              >
                Xem bảng giá →
              </Link>
            </div>
